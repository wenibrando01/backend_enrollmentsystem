...
@section('content')
    ...
    <div class="max-w-2xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow sm:rounded-lg overflow-hidden">
            <div class="px-6 py-6">
                <h1 class="text-xl font-semibold text-gray-900 mb-6">Create Course</h1>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="course_code" id="course_code" value="{{ old('course_code') }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" placeholder="e.g. CSE101">
                            @error('course_code')
